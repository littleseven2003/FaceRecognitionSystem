...
class Ui_MngWindow(object):
    def setupUi(self, MngWindow):
        ...
        self.changeButton_2 = QtWidgets.QPushButton(MngWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.changeButton_2.sizePolicy().hasHeightForWidth())
        self.changeButton_2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        self.changeButton_2.setFont(font)
        self.changeButton_2.setObjectName("changeButton_2")
        self.funLayout.addWidget(self.changeButton_2)
    ...
    def retranslateUi(self, MngWindow):
        ...
        item.setText(_translate("MngWindow", "新建列"))
        ...
        self.changeButton_2.setText(_translate("MngWindow", "修改"))
